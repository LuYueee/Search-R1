...
class RewardManager():
    ...
    def __init__(self, tokenizer, num_examine, model_path, structure_format_score=0., final_format_score=0., lambda_task=0., lambda_search_num=0., lambda_repeat_search_num=0.) -> None:
