...
export BASE_MODEL=/home/jovyan/work_vol90/RL+RAG/Search-R1-main/verl_checkpoints/nq_search-r1-ppo-qwen2.5-3b-it-em-format-retrieval/actor/global_step_100
export EXPERIMENT_NAME=${data_name}-r1-grpo-qwen2.5-3b-it-sent-rind
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_sent_rind \
    ...
    actor_rollout_ref.actor.optim.lr_warmup_steps_ratio=0.9 \
    ...
    reward_model.rind_threshold=1.5 \
    max_turns=4 \
