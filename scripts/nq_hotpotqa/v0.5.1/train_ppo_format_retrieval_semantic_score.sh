...
export EXPERIMENT_NAME=${data_name}-r1-ppo-qwen2.5-3b-it-em-sfllm-semantic-score-format-retrieval-0919
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_format_retrieval_sfllm_semantic_score \
    ...
    reward_model.lambda_task=5 \
    reward_model.lambda_search_num=0.1 \
    reward_model.lambda_repeat_search_num=0.2 \
    reward_model.model_path="aiplat/Qwen3-30B-A3B" \
    max_turns=4 \
