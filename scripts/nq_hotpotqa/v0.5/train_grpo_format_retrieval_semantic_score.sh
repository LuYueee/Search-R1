...
export EXPERIMENT_NAME=${data_name}-r1-grpo-qwen2.5-3b-it-em-semantic-score-format-retrieval
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_format_retrieval_semantic_score \
    ...
    reward_model.model_path="/home/jovyan/work_vol90/RL+RAG/Search-R1-main/models/qwen2.5-7b-instruct-1m" \
    max_turns=4 \
